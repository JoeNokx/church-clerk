        ...
        <table className="min-w-full">
          <thead className="bg-slate-100">
            <tr className="text-left text-xs font-semibold text-gray-500">
              ...
              <th className="px-6 max-sm:px-4 py-2 whitespace-nowrap"><div className="h-3 w-8 rounded bg-gray-200" /></th>
              <th className="px-6 max-sm:px-4 py-2 whitespace-nowrap"><div className="h-3 w-10 rounded bg-gray-200" /></th>
          ...
          <tbody className="divide-y divide-gray-200">
            {[0, 1, 2, 3, 4].map((i) => (
              <tr key={i} className="text-sm">
                <td className="px-6 max-sm:px-4 py-3 whitespace-nowrap">
                    ...
                    <div className="flex items-center justify-end gap-2">
                      {canView && (
                        <button
                          ...
                          className="rounded-md border border-gray-200 bg-white px-3 py-1.5 sm:py-1 text-xs font-semibold text-gray-700 hover:bg-gray-50 active:bg-gray-100"
                        >
                          View
                        </button>
                      )}
                      ...
                      {canDelete && (
                        <button
                          ...
                          className="rounded-md border border-gray-200 bg-white px-3 py-1.5 sm:py-1 text-xs font-semibold text-red-600 hover:bg-gray-50 active:bg-red-50"
                        >
                          Delete
                        </button>
                      )}
