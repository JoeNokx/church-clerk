        ...
        <div className="mt-4 h-56">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={attendanceGraph} margin={{ top: 6, right: 8, left: 0, bottom: 0 }}>
              ...
              <XAxis dataKey="month" tick={{ fontSize: 12 }} interval={0} tickFormatter={(v) => String(v || "").slice(0, 3)} />
              <YAxis tick={{ fontSize: 12 }} domain={[0, (dataMax) => Math.max(10, Math.ceil((Number(dataMax || 0) || 0) * 1.25))]} />
