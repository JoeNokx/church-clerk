import IndividualAttendance from "../../models/organisationModel/cellIndividualAttendanceModel.js";
...
const getAllCellIndividualAttendances = async (req, res) => {
  try {
    ...
    rows = await annotateDeletable("cellIndividualAttendance", rows, churchId);
