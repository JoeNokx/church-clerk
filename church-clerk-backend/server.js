...
app.use("/api/v1/organisations", Routes.cellRoute);
app.use("/api/v1/organisations", Routes.groupRoute);
app.use("/api/v1/organisations", Routes.departmentRoute);
app.use("/api/v1/organisations", Routes.ministryRoute);
