...
function ReportsAnalyticsPage() {
  ...
  const canRead = useMemo(() => (typeof can === "function" ? can("reportsAnalytics", "read") : true), [can]);
  ...
  const loadAnalytics = useCallback(async () => {
    ...
    try {
      const [kpiRes, analyticsRes] = await Promise.all([getReportsAnalyticsKpi(), getReportsAnalytics(analyticsParams)]);
