  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="text-xs text-gray-500">{valueFrom || valueTo ? "Filtered" : "All"}</span>
      </button>
    ...
    <div className="rounded-xl border border-blue-200 bg-blue-50 px-5 py-4">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="text-sm font-semibold text-gray-900">Tithe Mode: {isAggregate ? "Aggregate Recording" : "Individual Recording"}</div>
        </div>
  ...
  if (!canRead) {
    return (
      <div className="rounded-xl border border-gray-200 bg-white p-5 text-sm text-gray-700">
        You do not have permission to view tithes.
      </div>
    );
  }
      ...
      {view === "landing" ? (
        <div className="rounded-2xl border border-blue-100 bg-gradient-to-b from-blue-50 to-white px-6 py-12">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-10 text-center text-xs text-gray-500">You can switch your tithe recording mode anytime from the settings.</div>
          </div>
        </div>
      ) : (
        <>
