      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div
          className={`h-10 w-10 rounded-xl flex items-center justify-center ${
            type === "group" ? "bg-blue-50" : type === "cell" ? "bg-orange-50" : type === "ministry" ? "bg-pink-50" : "bg-purple-50"
          }`}
        >
  ...
  return (
    <div className="max-w-6xl">
      <div className="flex items-start justify-between gap-4">
        <div>
          <h2 className="text-2xl font-semibold text-gray-900">Organisations</h2>
          <p className="mt-2 text-sm text-gray-600">Manage groups, departments, cells and ministries in your church</p>
          ...
          <div className="mt-4 inline-flex rounded-lg border border-gray-200 bg-white p-1">
            ...
            <button type="button" onClick={() => setActiveTab("ministries")} className={`ml-1 ${tabClass("ministries")}`}>
              Ministries
              <span className="inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-purple-600 px-1.5 text-xs font-semibold text-white">
                {badges.ministries}
              </span>
            </button>
          </div>
        ...
        <div className="flex flex-col gap-3 border-b border-gray-200 p-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <input
              ...
              placeholder={activeTab === "groups" ? "Search group name..." : activeTab === "departments" ? "Search department name..." : activeTab === "ministries" ? "Search ministry name..." : "Search cell name..."}
