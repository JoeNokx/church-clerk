          ...
          <>
            ...
            <BigCard title="Personal Information" subtitle="Personal details of the member">
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <DataPair label="Date of Birth" value={member?.dateOfBirth ? new Date(member.dateOfBirth).toLocaleDateString() : ""} />
            ...
            <Section title="Notes" subtitle="Additional information">
