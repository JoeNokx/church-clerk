...
function ReferralProgramPage() {
  ...
  const canRead = useMemo(() => (typeof can === "function" ? can("referrals", "read") : true), [can]);
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                <button
                  ...
                  onClick={() =>
                    openShare(
                      `mailto:?subject=${encodeURIComponent("ChurchClerk Referral")}&body=${encodeURIComponent(shareMessage)}`
                    )
                  }
                  disabled={!referralCode}
                ...
                <button
                  type="button"
                  onClick={() =>
                    openShare(`https://twitter.com/intent/tweet?text=${encodeURIComponent(shareMessage)}&url=${encodeURIComponent(shareUrl)}`)
                  }
                  disabled={!referralCode || !shareUrl}
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <div className="mt-2 text-xs text-gray-500">
                            ...
                            {isRewarded ? (
                              <span className="ml-3 text-green-700">Subscribed: {formatDate(item?.subscribedAt)}</span>
                            ) : null}
                          </div>
                        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-5">
            ...
            <div className="mt-4 space-y-3 text-sm text-gray-700">
              <div className="flex items-start gap-3">
                <div className="mt-0.5 h-6 w-6 rounded-full bg-blue-50 ring-1 ring-blue-100 text-blue-900 flex items-center justify-center text-xs font-bold">
                  1
                </div>
