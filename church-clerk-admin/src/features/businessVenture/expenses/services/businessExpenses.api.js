...
export const updateBusinessExpense = async (businessId, expensesId, payload) => {
  return await http.put(`/business-ventures/business-ventures/${businessId}/expenses/${expensesId}`, payload);
};

export const deleteBusinessExpense = async (businessId, expensesId) => {
  return await http.delete(`/business-ventures/business-ventures/${businessId}/expenses/${expensesId}`);
};
