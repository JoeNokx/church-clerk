...
export const updateProjectContribution = async (projectId, contributionId, payload) => {
  return await http.put(`/church-project/church-projects/${projectId}/contributions/${contributionId}`, payload);
};

export const deleteProjectContribution = async (projectId, contributionId) => {
  return await http.delete(`/church-project/church-projects/${projectId}/contributions/${contributionId}`);
};
