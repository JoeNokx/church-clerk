...
function KpiCard({ title, value, change, subtitle, compareLabel, icon, onClick }) {
  ...
  const arrow = isUp ? (
    <svg viewBox="0 0 20 20" fill="currentColor" className="h-3.5 w-3.5">
      <path
        fillRule="evenodd"
        d="M10 3a1 1 0 01.894.553l4 8a1 1 0 01-.894 1.447H6a1 1 0 01-.894-1.447l4-8A1 1 0 0110 3Z"
        clipRule="evenodd"
      />
    </svg>
  ) : (
    <svg viewBox="0 0 20 20" fill="currentColor" className="h-3.5 w-3.5">
      <path
        fillRule="evenodd"
        d="M10 17a1 1 0 01-.894-.553l-4-8A1 1 0 015 7h10a1 1 0 01.894 1.447l-4 8A1 1 0 0110 17Z"
        clipRule="evenodd"
      />
    </svg>
  );
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border border-gray-200 bg-white overflow-hidden">
          <div className="flex items-start justify-between gap-3 border-b border-gray-200 bg-gray-50 px-5 py-4">
            ...
            <button type="button" onClick={openBirthdaysModal} className="text-sm font-semibold text-blue-700 hover:underline">
              View All
            </button>
          </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white overflow-hidden">
          <div className="flex items-start justify-between gap-3 border-b border-gray-200 bg-gray-50 px-5 py-4">
            ...
            <button type="button" onClick={() => toPage("members")} className="text-sm font-semibold text-blue-700 hover:underline">
              View All
            </button>
          </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white overflow-hidden">
          <div className="flex items-start justify-between gap-3 border-b border-gray-200 bg-gray-50 px-5 py-4">
            ...
            <button type="button" onClick={() => toPage("programs-events")} className="text-sm font-semibold text-blue-700 hover:underline">
              View All
            </button>
          </div>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <div className="mt-0.5 text-xs text-gray-500 truncate">
                          {formatRange(ev?.dateFrom, ev?.dateTo)} • {formatTimeRange(ev?.timeFrom, ev?.timeTo, ev?.time)}
                        </div>
                      </div>
